    ...
    <>
      <header className="sticky top-0 z-50 flex justify-between items-center px-6 md:px-12 py-4 bg-white/20 backdrop-blur-xl border-b border-white/30 shadow-2xl">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link href="/" className="text-sm font-semibold  hover:text-white transition-colors">Home</Link>
          <Link href="/products" className="text-sm font-semibold  hover:text-white transition-colors">Products</Link>
          <Link href="/admin/add-product" className="text-sm font-semibold  hover:text-white transition-colors">Admin</Link>
          <Link 
            href="/cart" 
